            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 ">Tambah Pengguna</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <form class="max-w-sm w-full" action="/user" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" id="name" name="name"
                    ...
                    value="{{ old('name') }}" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')"
            ...
            <div class="mb-5">
                ...
                <input type="text" id="nisn" name="nisn"
                    ...
                    value="{{ old('nisn') }}" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')"
                    oninput="setCustomValidity('')" />
                @error('nisn')
                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-5">
                ...
                <input type="email" id="email" name="email"
                    ...
                    value="{{ old('email') }}" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')"
                    oninput="setCustomValidity('')" />
                @error('email')
                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
