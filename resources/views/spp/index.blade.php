<x-app-layout>
    <div x-cloak x-data="{ open: false }">
        ...
        <div id="modal-cetak" tabindex="-1" aria-hidden="true"
            class=" overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full flex justify-center "
            x-show="open" >
            <div class="relative p-4 w-full max-w-md max-h-full" @click.outside="open = false">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow border border-black">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t ">
                        ...
                        <button type="button"
                            ...
                            data-modal-hide="modal-cetak" x-on:click="open = false">
                            ...
                            <div>
                                <table>
                                    <tr>
                                        ...
                                        <td class="pl-2"> <select id="selecttahunajaran"
                                                class=" operator w-56 container" name="tahunajaran" required
                                    ...
                                    <tr class="h-14">
                                        ...
                                        <td class="pl-2"> <select id="selectkelompokcetak"
                                                class="operator w-56 container" name="kelompok" required
                                                oninvalid="this.setCustomValidity('Data tidak boleh kosong')"
                                                oninput="setCustomValidity('')">
                                                <option value="">select...</option>
